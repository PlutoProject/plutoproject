...
val COMMAND_FLAG_UNKNOWN_KEY = component {
    ...
    newline()
    text("使用 /flagv list 查看所有已注册的 flag") with mochaSubtext0
}
...
val COMMAND_FLAG_INVALID_SCOPE_FLAG = component {
    text("无法识别的 scope flag，可用：--global、--server、--player [玩家]") with mochaMaroon
}

val COMMAND_FLAG_GET_REQUIRES_TARGET = component {
    text("get 的 --player 必须提供具体的玩家") with mochaMaroon
}
