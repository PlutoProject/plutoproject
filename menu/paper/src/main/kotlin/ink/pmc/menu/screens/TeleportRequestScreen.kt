...
private const val COLUMES_PRE_PAGE = 3
private const val PLAYERS_PRE_PAGE = PLAYERS_PRE_COLUMN * COLUMES_PRE_PAGE
...
class TeleportRequestScreen : Screen {
    ...
    private fun Base(contents: ComposableFunction) {
        Row(modifier = Modifier.fillMaxWidth().height(COLUMES_PRE_PAGE), horizontalArrangement = Arrangement.Center) {
